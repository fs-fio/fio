...
let ceTests =
    testList
        ...
        [
            ...
            <| fun (runtime: FIORuntime, a: int, b: int, c: int) ->
                let eff =
                    fio.Bind3(FIO.succeed a, FIO.succeed b, FIO.succeed c, fun (x, y, z) -> FIO.succeed (x + y + z))
            ...
            <| fun (runtime: FIORuntime, a: int, b: int, c: int) ->
                let eff =
                    fio.Bind3Return(FIO.succeed a, FIO.succeed b, FIO.succeed c, fun (x, y, z) -> x + y + z)
