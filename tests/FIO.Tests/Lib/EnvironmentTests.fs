...
let environmentTests =
    ...
    <| testList
        ...
        [
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.get ("PATH", fun () -> "not found")).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.get (nonExistentVar, fun () -> "not found")).UnsafeError()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.getOrDefault ("PATH", "default")).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime, defaultValue: string) ->
                let result =
                    runtime.Run(Environment.getOrDefault (nonExistentVar, defaultValue)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime
                        .Run(
                            Environment.getInt (nonExistentVar, (fun () -> "not found"), (fun s -> $"parse error: {s}"))
                        )
                        .UnsafeError()
            ...
            <| fun (runtime: FIORuntime) ->
                ...
                try
                    let result =
                        runtime.Run(Environment.getIntOrDefault ("FIO_TEST_INT", 0)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                ...
                try
                    let result =
                        runtime.Run(Environment.getIntOrDefault ("FIO_TEST_INT", 99)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.getIntOrDefault (nonExistentVar, 99)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                ...
                try
                    let result =
                        runtime
                            .Run(
                                Environment.getBool ("FIO_TEST_BOOL", (fun () -> "not found"), (fun _ -> "parse error"))
                            )
                            .UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime
                        .Run(Environment.getBool (nonExistentVar, (fun () -> "not found"), (fun _ -> "parse error")))
                        .UnsafeError()
            ...
            <| fun (runtime: FIORuntime) ->
                ...
                try
                    let result =
                        runtime.Run(Environment.getBoolOrDefault ("FIO_TEST_BOOL", false)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                ...
                try
                    let result =
                        runtime.Run(Environment.getBoolOrDefault ("FIO_TEST_BOOL", true)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.getBoolOrDefault (nonExistentVar, true)).UnsafeSuccess()
            ...
            <| fun (runtime: FIORuntime) ->
                let result =
                    runtime.Run(Environment.getFolderPath System.Environment.SpecialFolder.UserProfile).UnsafeSuccess()
