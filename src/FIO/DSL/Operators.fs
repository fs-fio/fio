...
let inline ( *> ) (eff: FIO<'A, 'E>) (eff': FIO<'A1, 'E>) : FIO<'A1, 'E> =
    eff.ZipRight eff'
...
let inline (<*) (eff: FIO<'A, 'E>) (eff': FIO<'A1, 'E>) : FIO<'A, 'E> =
    eff.ZipLeft eff'
...
let inline (<*>) (eff: FIO<'A, 'E>) (eff': FIO<'A1, 'E>) : FIO<'A * 'A1, 'E> =
    eff.Zip eff'
...
let inline (<&&>) (eff: FIO<'A, 'E>) (eff': FIO<'A1, 'E>) : FIO<unit, 'E> =
    eff.ZipPar(eff').Unit()
...
let inline (<|>) (eff: FIO<'A, 'E>) (eff': FIO<'A, 'E1>) : FIO<'A, 'E1> =
    eff.OrElse eff'
...
let inline (>>=) (eff: FIO<'A, 'E>) (cont: 'A -> FIO<'A1, 'E>) : FIO<'A1, 'E> =
    eff.FlatMap cont
...
let inline (<!>) (mapper: 'A -> 'A1) (eff: FIO<'A, 'E>) : FIO<'A1, 'E> =
    eff.Map mapper
