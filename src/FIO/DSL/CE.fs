...
type FIOBuilder internal () =
    ...
    /// <param name="eff''">The third FIO effect.</param>
    /// <param name="cont">The continuation function.</param>
    member inline this.Bind3<'R, 'R1, 'R2, 'ROut, 'E>
        (eff: FIO<'R, 'E>, eff': FIO<'R1, 'E>, eff'': FIO<'R2, 'E>, cont: 'R * 'R1 * 'R2 -> FIO<'ROut, 'E>)
        : FIO<'ROut, 'E> =
    ...
    /// <param name="eff'''">The fourth FIO effect.</param>
    /// <param name="cont">The continuation function.</param>
    member inline this.Bind4<'R, 'R1, 'R2, 'R3, 'ROut, 'E>
        (
            eff: FIO<'R, 'E>,
            eff': FIO<'R1, 'E>,
            eff'': FIO<'R2, 'E>,
            eff''': FIO<'R3, 'E>,
            cont: 'R * 'R1 * 'R2 * 'R3 -> FIO<'ROut, 'E>
        ) : FIO<'ROut, 'E> =
    ...
    /// <param name="eff''''">The fifth FIO effect.</param>
    /// <param name="cont">The continuation function.</param>
    member inline this.Bind5<'R, 'R1, 'R2, 'R3, 'R4, 'ROut, 'E>
        (
            eff: FIO<'R, 'E>,
            eff': FIO<'R1, 'E>,
            eff'': FIO<'R2, 'E>,
    ...
    /// <param name="eff''">The third FIO effect.</param>
    /// <param name="cont">The mapping function.</param>
    member inline this.Bind3Return<'R, 'R1, 'R2, 'ROut, 'E>
        (eff: FIO<'R, 'E>, eff': FIO<'R1, 'E>, eff'': FIO<'R2, 'E>, cont: 'R * 'R1 * 'R2 -> 'ROut)
        : FIO<'ROut, 'E> =
    ...
    /// <param name="eff'''">The fourth FIO effect.</param>
    /// <param name="cont">The mapping function.</param>
    member inline this.Bind4Return<'R, 'R1, 'R2, 'R3, 'ROut, 'E>
        (
            eff: FIO<'R, 'E>,
            eff': FIO<'R1, 'E>,
            eff'': FIO<'R2, 'E>,
            eff''': FIO<'R3, 'E>,
            cont: 'R * 'R1 * 'R2 * 'R3 -> 'ROut
        ) : FIO<'ROut, 'E> =
    ...
    /// <param name="eff''''">The fifth FIO effect.</param>
    /// <param name="cont">The mapping function.</param>
    member inline this.Bind5Return<'R, 'R1, 'R2, 'R3, 'R4, 'ROut, 'E>
        (
            eff: FIO<'R, 'E>,
            eff': FIO<'R1, 'E>,
            eff'': FIO<'R2, 'E>,
