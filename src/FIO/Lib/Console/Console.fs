...
/// </summary>
/// <param name="format">The format string.</param>
let printExn (format: Printf.TextWriterFormat<unit>) : FIO<unit, exn> = print<exn> (format, id)
...
/// </summary>
/// <param name="format">The format string.</param>
let printErrorExn (format: Printf.TextWriterFormat<unit>) : FIO<unit, exn> = printError<exn> (format, id)
...
/// </summary>
/// <param name="format">The format string.</param>
let printLineExn (format: Printf.TextWriterFormat<unit>) : FIO<unit, exn> = printLine<exn> (format, id)
...
/// </summary>
/// <param name="format">The format string.</param>
let printErrorLineExn (format: Printf.TextWriterFormat<unit>) : FIO<unit, exn> = printErrorLine<exn> (format, id)
...
/// Reads a line from stdin.
/// </summary>
let readLineExn: FIO<string, exn> = readLine<exn> id
...
/// </summary>
/// <param name="intercept">Whether to hide the key from display.</param>
let readKeyExn (intercept: bool) : FIO<ConsoleKeyInfo, exn> = readKey<exn> (intercept, id)
...
/// Gets a value indicating whether a key press is available in the input stream.
/// </summary>
let keyAvailableExn: FIO<bool, exn> = keyAvailable<exn> id
...
/// Reads a single character from stdin as an int.
/// </summary>
let readExn: FIO<int, exn> = read<exn> id
...
/// </summary>
/// <param name="message">The message to write.</param>
let writeExn (message: string) : FIO<unit, exn> = write<exn> (message, id)
...
/// </summary>
/// <param name="message">The message to write.</param>
let writeLineExn (message: string) : FIO<unit, exn> = writeLine<exn> (message, id)
...
/// Writes a blank line to stdout.
/// </summary>
let newLineExn: FIO<unit, exn> = newLine<exn> id
...
/// </summary>
/// <param name="message">The message to write.</param>
let writeErrorExn (message: string) : FIO<unit, exn> = writeError<exn> (message, id)
...
/// </summary>
/// <param name="message">The message to write.</param>
let writeErrorLineExn (message: string) : FIO<unit, exn> = writeErrorLine<exn> (message, id)
...
/// Clears the console.
/// </summary>
let clearExn: FIO<unit, exn> = clear<exn> id
...
/// </summary>
/// <param name="left">The column position.</param>
let setCursorLeftExn (left: int) : FIO<unit, exn> = setCursorLeft<exn> (left, id)
...
/// </summary>
/// <param name="top">The row position.</param>
let setCursorTopExn (top: int) : FIO<unit, exn> = setCursorTop<exn> (top, id)
...
/// Gets the cursor column position.
/// </summary>
let getCursorLeftExn: FIO<int, exn> = getCursorLeft<exn> id
...
/// Gets the cursor row position.
/// </summary>
let getCursorTopExn: FIO<int, exn> = getCursorTop<exn> id
...
/// Sounds the system bell.
/// </summary>
let beepExn: FIO<unit, exn> = beep<exn> id
...
/// Gets the console foreground color.
/// </summary>
let getForegroundColorExn: FIO<ConsoleColor, exn> = getForegroundColor<exn> id
...
/// </summary>
/// <param name="color">The color to set.</param>
let setForegroundColorExn (color: ConsoleColor) : FIO<unit, exn> = setForegroundColor<exn> (color, id)
...
/// Gets the console background color.
/// </summary>
let getBackgroundColorExn: FIO<ConsoleColor, exn> = getBackgroundColor<exn> id
...
/// </summary>
/// <param name="color">The color to set.</param>
let setBackgroundColorExn (color: ConsoleColor) : FIO<unit, exn> = setBackgroundColor<exn> (color, id)
...
/// Gets the console window title.
/// </summary>
let getTitleExn: FIO<string, exn> = getTitle<exn> id
...
/// </summary>
/// <param name="title">The title to set.</param>
let setTitleExn (title: string) : FIO<unit, exn> = setTitle<exn> (title, id)
...
/// Checks whether stdin is redirected.
/// </summary>
let isInputRedirectedExn: FIO<bool, exn> = isInputRedirected<exn> id
...
/// Checks whether stdout is redirected.
/// </summary>
let isOutputRedirectedExn: FIO<bool, exn> = isOutputRedirected<exn> id
...
/// Checks whether stderr is redirected.
/// </summary>
let isErrorRedirectedExn: FIO<bool, exn> = isErrorRedirected<exn> id
...
/// Resets the console colors to their defaults.
/// </summary>
let resetColorExn: FIO<unit, exn> = resetColor<exn> id
...
/// <param name="left">The column position.</param>
/// <param name="top">The row position.</param>
let setCursorPositionExn (left: int, top: int) : FIO<unit, exn> = setCursorPosition<exn> (left, top, id)
...
/// Gets the cursor position as (column, row).
/// </summary>
let getCursorPositionExn: FIO<int * int, exn> = getCursorPosition<exn> id
...
/// Gets whether the cursor is visible.
/// </summary>
let getCursorVisibleExn: FIO<bool, exn> = getCursorVisible<exn> id
...
/// </summary>
/// <param name="visible">True to show the cursor, false to hide it.</param>
let setCursorVisibleExn (visible: bool) : FIO<unit, exn> = setCursorVisible<exn> (visible, id)
...
/// Gets the console window width.
/// </summary>
let getWindowWidthExn: FIO<int, exn> = getWindowWidth<exn> id
...
/// Gets the console window height.
/// </summary>
let getWindowHeightExn: FIO<int, exn> = getWindowHeight<exn> id
...
/// Gets the console buffer width.
/// </summary>
let getBufferWidthExn: FIO<int, exn> = getBufferWidth<exn> id
...
/// Gets the console buffer height.
/// </summary>
let getBufferHeightExn: FIO<int, exn> = getBufferHeight<exn> id
...
/// </summary>
/// <param name="lines">The lines to write.</param>
let printLinesExn (lines: string seq) : FIO<unit, exn> = printLines<exn> (lines, id)
...
/// Reads a password from stdin with masked input.
/// </summary>
let readPasswordExn: FIO<string, exn> = readPassword<exn> id
